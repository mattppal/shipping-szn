...
1. **Clarity**: Can someone new to the topic understand this?
2. **Accuracy**: Are all technical details correct?
3. **Completeness**: Are there gaps that would confuse readers?
4. **Tone**: Does it match Replit's brand voice?
5. **Links**: Are all references valid and helpful?
...
Read [GOOD_DOCS.md](GOOD_DOCS.md) for:
...
When reviewing:
1. Point out specific issues with line references
2. Suggest concrete improvements (not just "make it better")
3. Provide rewritten examples when helpful
4. Balance criticism with recognition of what works well
